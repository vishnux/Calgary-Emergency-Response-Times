...
with col1:
     ...
     st.write('''
     In the event of an emergency, T3S and T1X are the FSAs with the lowest coverage, potentially leaving those areas vulnerable and in need of additional support. 
     The following bar chart shows the average response times by Forward Sortation Area (FSA) in minutes. You can hover over the bars to see the exact values.''')
